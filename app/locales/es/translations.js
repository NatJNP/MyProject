export default {
  admin: {
    ...
    addressOptions: 'Opciones Direcciones',
    customForms: {
      buttons: {
      ...
      labels: {
        ...
        dischargeReportFormType: 'Informe de Descargo',
        expenseTo: 'Gasto A',
        formName: 'De Nombre',
        formType: 'De Tipo',
        ...
        label: 'Etiqueta',
        newForm: 'Nuevo Formulario',
        opdReportFormType: 'Informe Paciente Externo',
        operativePlanFormType: 'Operacional Plan e Informe',
        otherOptionLabel: 'Otras Etiquetas Opcion',
